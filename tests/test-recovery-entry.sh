...
grep -q 'PF_RECOVERY_SHA=443a84e47c96d83de967948844d8e5eaa41d7413' "$ROOT/build/Dockerfile.pf"
grep -q '^FROM rust:1\.88-slim-bookworm@sha256:38bc5a86d998772d4aec2348656ed21438d20fcdce2795b56ca434cf21430d89 AS recovery$' "$ROOT/build/Dockerfile.pf"
