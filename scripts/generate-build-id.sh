...
# PF_GPU_SHA, PF_LAUNCHER_SHA, PF_HWPROBE_SHA, and PF_SIM_SHA are NOT required — each
# is legitimately empty on one path,
...
#   - PF_HWPROBE_SHA : empty on release (hwprobe is a dev-only diagnostic).
